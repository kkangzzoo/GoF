...
// Description : using singleton pattern 
//============================================================================
...
public:
	static void InitUnitArray(){
		for(int i=0; i<N_UNIT; i++)	pUnitArray_[i]=0;
	}
...
int main() {
	...
	if(pUnit1==0)	cout<<"No More Create Unit"<<endl;

	GameUnit *pUnit2 = ProtectUnit::CreateInstance();
	if(pUnit2==0)	cout<<"No More Create Unit"<<endl;
